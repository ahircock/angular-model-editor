...
export class DataAccessService {
    ...
    async getRules(): Promise<RuleDBData[]> {
        return ( this.httpClient.get(
            ...
            ).toPromise() as Promise<RuleDBData[]>);
    }
    ...
    async updateRule( updateRule: RuleDBData ): Promise<RuleDBData> {
        const url = this.apiUrlRules + '/' + updateRule._id;
    ...
    async deleteRule( deleteRule: RuleDBData ): Promise<void> {
        const url = this.apiUrlRules + '/' + deleteRule._id;
    ...
    async getModels(): Promise<ModelDBData[]> {
        return ( this.httpClient.get(
                this.apiUrlModels,
                {headers: {'sessionid': this.sessionid}}
            ).toPromise() as Promise<ModelDBData[]>);
    }
    ...
    async updateModel( updateModel: ModelDBData ): Promise<ModelDBData> {
        const url = this.apiUrlModels + '/' + updateModel._id;
        return ( this.httpClient.put(
                url,
                updateModel,
                {headers: {'sessionid': this.sessionid}}
    ...
    async deleteModel( deleteModel: ModelDBData ): Promise<void> {
        const url = this.apiUrlModels + '/' + deleteModel._id;
        this.httpClient.delete(
                url,
                {headers: {'sessionid': this.sessionid}}
            ).toPromise();
    ...
    async getForces(): Promise<ForceDBData[]> {
        return ( this.httpClient.get(
                this.apiUrlForces,
                {headers: {'sessionid': this.sessionid}}
            ).toPromise() as Promise<ForceDBData[]>);
    }
    ...
    async getActions(): Promise<ActionDBData[]> {
        return ( this.httpClient.get(
                this.apiUrlActions,
                {headers: {'sessionid': this.sessionid}}
            ).toPromise() as Promise<ActionDBData[]>);
    }
    ...
    async updateAction( updateAction: ActionDBData ): Promise<ActionDBData> {
        const url = this.apiUrlActions + '/' + updateAction._id;
        return ( this.httpClient.put(
                url,
                updateAction,
                {headers: {'sessionid': this.sessionid}}
    ...
    async deleteAction( deleteAction: ActionDBData ): Promise<void> {
        const url = this.apiUrlActions + '/' + deleteAction._id;
        this.httpClient.delete(
                url,
                {headers: {'sessionid': this.sessionid}}
            ).toPromise();
